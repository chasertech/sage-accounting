...
const bankDeposits = require('./bank_deposits');
const bankReconciliations = require('./bank_reconciliations');
const bankTransfers = require('./bank_transfers');
const otherPayments = require('./other_payments');
const transactions = require('./transactions');
const contactPayments = require('./contact_payments');
const contactPersonTypes = require('./contact_person_types');
const contactPersons = require('./contact_persons');
...
const business_relationships = require('./miscellaneous/business_relationships');
    ...
    async getAccessToken(redirectUri, authorizationCode, country) {
        ...
        const token = await request.post(tokenUrl, {
            body: {
                ...
                redirect_uri: redirectUri, // was http://localhost:3000/callback
...
Object.assign(SageOne.prototype, business_relationships);
